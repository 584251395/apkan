...
public interface BaseDao<T> {
	...
	public void saveList(List<T> obj);//保存多条数据
	...
	public PageModel<T> find(int pageNo, int maxResult,String select,String where, Object[] queryParams);//搜索信息分页方法
	public PageModel<T> find(int pageNo, int maxResult,Map<String, String> orderby);//按指定条件排序分页方法
	public PageModel<T> find(String select, String where, Object[] queryParams,
